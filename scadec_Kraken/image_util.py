...
def get_data_provider(para_dict_use, mode = 'train', DEBUG_MODE = False):
    ...
    if type(para_dict_use['kwargs'][0]['structure']) == str:
        data_cls_num = para_dict_use['kwargs'][0].get('n_classes',1)
    else:
        data_cls_num = para_dict_use['kwargs'][0]['structure'].get('n_classes', 1)
    # print(data_cls_num)
    if DEBUG_MODE:
        # Observation
