...
def unet_decoder(x, keep_prob, phase, img_channels, truth_channels, layers=3, conv_times=3, features_root=16, filter_size=3, pool_size=2, summaries=True, get_loss_dict = True, batch_size = 5, valid_size = 5, structure={'type':'Nagini'}, **otherParas):#, n_classes = 8, structure='Hydra', neck_len = 3):
    """
