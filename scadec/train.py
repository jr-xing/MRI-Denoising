...
class Trainer_bn(object):
            ...
            for epoch in range(epochs):
                ...
                for step in range((epoch*training_iters), ((epoch+1)*training_iters)):
                    ...
                    if self.net.get_loss_dict:
                        ...
                        _, loss, lr, avg_psnr, train_output = sess.run([self.optimizer,
                ...
                self.output_valstats(sess, summary_writer, step, valid_x, valid_y, "epoch_%s_valid"%epoch, store_img=True, get_loss_dict = self.net.get_loss_dict)
                # Xing
                if SAVE_TRAIN_PRED:
                    if SAVE_MODE == 'Original':
    ...
    def output_valstats(self, sess, summary_writer, step, batch_x, batch_y, name, store_img=True, get_loss_dict=False):
        if get_loss_dict:
