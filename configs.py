...
# rerun 63 with smaller network
para_str_64 = 'Idx_64-Loss_l2-Loss_preMask-Reg_no-Drop_0.8-Ob_FULL_SEG_3C_motion-Gt_FULL_SEG-LessClass-Nagini_4_Ouroboros'
para_dict_64 = {
    'idx':64,
    'losses':[
        {
...
# rerun64 with gradient loss
para_str_65 = 'Idx_65-Loss_l2-Loss_gradient_type_3_w_20-Loss_preMask-Reg_no-Drop_0.8-Ob_FULL_SEG_3C_motion-Gt_FULL_SEG-LessClass-Nagini_4_Ouroboros'
para_dict_65 = {
    'idx':65,
    'losses':[
        {
...
# re-run 65 with less grad loss
para_str_66 = 'Idx_66-Loss_l2-Loss_gradient_type_3_w_20-Loss_preMask-Reg_no-Drop_0.8-Ob_FULL_SEG_3C_motion-Gt_FULL_SEG-LessClass-Nagini_4_Ouroboros'
para_dict_66 = {
    'idx':66,
    'losses':[
        {
...
# with l1 loss, l1 gradient loss and differene addMask
# previous version wrongly used l2 loss, and gradient weight is 20
para_str_69 = 'Idx_69-Loss_l1-Loss_gradient_type_1_w_50-Loss_preMask_p02-Reg_no-Drop_1-Ob_FULL_SEG_3C_motion-Gt_FULL_SEG-LessClass-Nagini_4_Ouroboros'
para_dict_69 = {
    'idx':69,
    'losses':[
        {
...
# re-run 69 with deeper network
# previous version wrongly used l2 loss, and gradient weight is 20
para_dict_70 = para_dict_69.copy()
para_dict_70['kwargs']['layers'] = 4
para_dict_70['kwargs']['features_root'] = 48
para_dict_70['idx'] = 70
